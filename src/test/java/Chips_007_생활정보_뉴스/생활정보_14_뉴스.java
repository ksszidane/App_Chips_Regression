...
public class 생활정보_14_뉴스 extends Chips_TestCase {
	...
	public void TC_0811_Chips_뉴스_기본설정_CBS뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "최신 CBS 주요 뉴스를 들려드릴게요."));
	...
	public void TC_0813_Chips_뉴스_KBS뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "최신 KBS 주요 뉴스를 들려드릴게요."));
	...
	public void TC_0815_Chips_뉴스_SBS뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "최신 SBS 주요 뉴스를 들려드릴게요."));
	...
	public void TC_0815_1_Chips_뉴스_MBC뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "최신 MBC 주요 뉴스를 들려드릴게요."));
	...
	public void TC_0815_2_Chips_뉴스_TBS뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "최신 TBS 주요 뉴스를 들려드릴게요."));
	...
	public void TC_0815_2_Chips_뉴스_연합뉴스뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "최신 연합뉴스 주요 뉴스를 들려드릴게요."));
	...
	public void TC_0818_Chips_뉴스_스포츠특정뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "스포츠 관련, 최근 뉴스를 들려드릴게요."));
	...
	public void TC_0819_Chips_뉴스_미지원채널_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "아쉽게도, 아직 매경 뉴스는 제공하지 않아요."));
	...
	public void TC_0820_Chips_뉴스_미지원채널_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "아쉽게도, 아직 조선일보 뉴스는 제공하지 않아요."));
	...
	public void TC_0821_Chips_뉴스_SK텔레콤_키워드뉴스_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "스포츠 뉴스 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "SK텔레콤 관련, 최근 뉴스를 들려드릴게요."));
	...
	public void TC_0822_Chips_뉴스_세종병원화재_키워드뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "세종병원 화재 관련"));
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "뉴스를 들려드릴게요."));
	...
	public void TC_0823_Chips_뉴스_컴퓨터_키워드뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "컴퓨터 관련, 최근 뉴스를 들려드릴게요."));
	...
	public void TC_0824_Chips_뉴스_NUGU토픽_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "NUGU 토픽 입니다."));
	...
	public void TC_0825_Chips_뉴스_키워드뉴스없음_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "주식회사 티벨 박이슬 박사 관련 뉴스를 찾지 못했습니다."));
	...
	public void TC_0826_Chips_뉴스_지난주뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "최근 업데이트된 뉴스를 제공하고 있어요. 최신 CBS 주요 뉴스를 들려드릴게요."));
	...
	public void TC_0827_Chips_뉴스_지난주연예뉴스_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  지난주주말));
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "연예 관련 뉴스를 들려드릴게요."));
	...
	public void TC_0828_Chips_뉴스_N월첫째주스포츠뉴스_확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("1월 첫째주 스포츠 뉴스 틀어줘",  Chips_001, ServerName, AccessToken, "news");
		
		test.log(Status.INFO, "뉴스 타이틀 확인");
		Assert.assertTrue(util.getText_Assertfunc(By.xpath(xPath.FLO카드타이틀), "스포츠 뉴스"));
		
		test.log(Status.INFO, "스포츠 뉴스 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "스포츠 관련 뉴스를 들려드릴게요."));
	...
	public void TC_0829_Chips_뉴스_지난주SK텔레콤뉴스_확인(Method method) throws Exception {
		...
		util.SWFsendPost("지난 주 SK텔레콤 뉴스 틀어줘",  Chips_001, ServerName, AccessToken);
		util.SWFsendPost("지난 주 SK텔레콤 뉴스 틀어줘",  Chips_001, ServerName, AccessToken);
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "SK텔레콤 관련 뉴스를 들려드릴게요."));
