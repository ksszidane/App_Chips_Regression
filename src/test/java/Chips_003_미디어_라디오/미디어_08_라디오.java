...
public class 미디어_08_라디오 extends Chips_TestCase {
	...
	public void TC_0342_Chips_라디오_좋아요재생_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "즐겨찾기 한 라디오 채널이 없습니다. 누구 앱에서 자주 듣는 채널을 즐겨찾기로 등록해주세요."));
	...
	public void TC_0343_Chips_라디오_즐겨찾기있음_재생_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "즐겨찾기 리스트에 추가했습니다."));
	...
	public void TC_0344_Chips_라디오_즐겨찾기있음_재생_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "즐겨찾기 리스트에서 삭제하였습니다."));
	...
	public void TC_0345_Chips_라디오_듣고있는라디오_채널_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "즐겨찾기한 재생한 라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "이 라디오는  TBN 강원교통방송  입니다."));
	...
	public void TC_0347_Chips_라디오_다음라디오_채널_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "SBS 파워FM 라디오를 들려드릴게요."));
		Thread.sleep(5000);
	...
	public void TC_0354_Chips_라디오_일시정지상태_채널재생_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "이 라디오는  SBS 파워FM  입니다."));
	...
	public void TC_0355_Chips_라디오_대기상태_채널목록_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "채널 안내 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "8개 방송국, 27개의 채널이 있습니다. SBS, KBS, CBS, TBS, 아리랑, 불교방송, 극동방송, TBN 라디오를 들을 수 있어요."));
	...
	public void TC_0358_Chips_라디오_즐겨찾기완료_즐겨찾기실행_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "즐겨찾기 라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "이미 즐겨찾기로 등록된 채널입니다."));
	...
	public void TC_0360_Chips_라디오_즐겨찾기해제완료_즐겨찾기해제_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "즐겨찾기해제 라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "즐겨찾기 한 채널이 아닙니다."));
