...
public class 미디어_09_라디오_채널확인 extends Chips_TestCase {
	...
	public void TC_0361_Chips_라디오_지원채널_SBS러브FM_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "SBS 러브FM 라디오"));
	...
	public void TC_0363_Chips_라디오_지원채널_교통방송FM_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBS FM 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0364_Chips_라디오_지원채널_TBSeFM_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBS eFM 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0367_Chips_라디오_지원채널_TBN경남교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 경남교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0368_Chips_라디오_지원채널_TBN경북교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 경북교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0369_Chips_라디오_지원채널_TBN경인교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 경인교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0370_Chips_라디오_지원채널_TBN광주교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 광주교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0371_Chips_라디오_지원채널_TBN대구교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 대구교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0372_Chips_라디오_지원채널_TBN대전교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 대전교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0373_Chips_라디오_지원채널_TBN부산교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 부산교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0374_Chips_라디오_지원채널_TBN울산교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 울산교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0375_Chips_라디오_지원채널_TBN전북교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 전북교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0376_Chips_라디오_지원채널_TBN제주교통방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBN 제주교통방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0378_Chips_라디오_지원채널_아리랑FM_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "Arirang FM 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0379_Chips_라디오_지원채널_극동방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "극동방송 FM 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0380_Chips_라디오_지원채널_불교방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "BBS 불교방송 FM 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0382_Chips_라디오_지원채널_CBS음악FM_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "CBS 음악FM 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0383_Chips_라디오_지원채널_CBS표준FM_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "CBS 표준FM 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0386_Chips_라디오_지원채널_KBS1라디오_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "KBS 1 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0387_Chips_라디오_지원채널_KBS2라디오_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "KBS 2 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0388_Chips_라디오_지원채널_KBS3라디오_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "KBS 3 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0389_Chips_라디오_지원채널_KBS클래식FM_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "KBS ClassicFM 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0390_Chips_라디오_지원채널_KBScoolFM_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "KBS CoolFM 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0391_Chips_라디오_지원채널_KBSHappyFM_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "W, KBS Happy FM 틀어줘 - 발화");
		util.SWFsendPost_playStatus("KBS Happy FM 틀어줘", Chips_001, ServerName, AccessToken, "radio");
		Thread.sleep(7000);
	...
	public void TC_0392_Chips_라디오_지원채널_KBSworld_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "KBS 월드 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0393_Chips_라디오_지원채널_KBS한민족방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "KBS 한민족방송 라디오"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0396_Chips_라디오_미지원채널_동양방송_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "라디오 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "현재 디바이스에서는 지원하지 않는 라디오 채널입니다."));
