...
public class 생활정보_11_날씨_일몰시간 extends Chips_TestCase {
	...
	public void TC_0781_Chips_날씨_일몰시간_확인(Method method) throws Exception {
		...
		util.SWFsendPost("일몰 시간", Chips_001, ServerName, AccessToken);
		
		test.log(Status.INFO, "일몰시간 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Place, Service,  "오늘 " + 현재위치 + "일몰시각은"));
	...
	public void TC_0782_Chips_날씨_지역_일몰시간_확인(Method method) throws Exception {
		...
		util.SWFsendPost("부산 해 지는 시간 알려줘", Chips_001, ServerName, AccessToken);

		test.log(Status.INFO, "일몰시간 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Place, Service,  "오늘 부산일몰시각은"));
	}
	...
	public void TC_0783_Chips_날씨_오늘_일몰시간_확인(Method method) throws Exception {
		...
		util.SWFsendPost("오늘 일몰 시간", Chips_001, ServerName, AccessToken);
	...
	public void TC_0784_Chips_날씨_오늘지역_일몰시간_확인(Method method) throws Exception {
		...
		util.SWFsendPost("오늘 부산 해 지는 시간 알려줘", Chips_001, ServerName, AccessToken);
	...
	public void TC_0785_Chips_날씨_내일_일몰시간_확인(Method method) throws Exception {
		...
		util.SWFsendPost("내일 일몰 시간", Chips_001, ServerName, AccessToken);
		
		test.log(Status.INFO, "내일 일몰시간 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Place, Service,  "내일 " + 현재위치 + "일몰시각은"));
	}
	...
	public void TC_0786_Chips_날씨_내일지역_일몰시간_확인(Method method) throws Exception {
		...
		util.SWFsendPost("내일 부산 해 지는 시간 알려줘", Chips_001, ServerName, AccessToken);
		
		test.log(Status.INFO, "내일 일몰시간 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Place, Service,  "내일 부산일몰시각은"));
