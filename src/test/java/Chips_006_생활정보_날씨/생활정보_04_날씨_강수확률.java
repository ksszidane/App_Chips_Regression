...
public class 생활정보_04_날씨_강수확률 extends Chips_TestCase {
	...
	public void TC_0737_Chips_날씨_현재_강수확률_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.지금강수확률_set));
	}
	...
	public void TC_0738_Chips_날씨_오늘_강수확률_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "지금 비 와? TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.오늘강수확률_set));
	}
	...
	public void TC_0739_Chips_날씨_내일_강수확률_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "지금 비 와? TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.내일강수확률_set));
	}
	...
	public void TC_0740_Chips_날씨_모레_강수확률_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  모레날짜 + " " + 모레요일+ "요일은"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.모레강수확률_set));
	}
