...
public class 미디어_06_자체소싱 extends Chips_TestCase {
	...
	public void TC_0300_Chips_자체소싱_재생_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "부스트파크송"));
	...
	public void TC_0301_Chips_자체소싱_재생_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "걸그룹 장르 노래 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "SK텔레콤의 부스트파크송"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0306_Chips_자체소싱_다음_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.한곡재생_set));
