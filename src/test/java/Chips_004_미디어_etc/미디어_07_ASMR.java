...
public class 미디어_07_ASMR extends Chips_TestCase {
	...
	public void TC_0315_Chips_ASMR_재생_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "ASMR"));
	...
	public void TC_0316_Chips_ASMR_과자먹는소리재생_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "ASMR 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "과자 먹는 소리"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0317_Chips_ASMR_빗소리_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "ASMR 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "빗소리"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0318_Chips_ASMR_힐링사운드_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "ASMR 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "힐링사운드"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0319_Chips_ASMR_자연의소리_반복확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "ASMR 재생 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "자연의 소리 반복해드릴게요."));
	...
	public void TC_0320_Chips_ASMR_이노래뭐야_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  곡명));
	...
	public void TC_0324_Chips_ASMR_재생_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "자연의소리"));
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa001, Chips_001, ServerName, Service,  data.음악시작_set));
	...
	public void TC_0329_Chips_ASMR_좋아요_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "좋아요 기능을 지원하지 않는 곡이에요."));
