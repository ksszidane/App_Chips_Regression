...
public class 미디어_12_팟빵 extends Chips_TestCase {
	...
	public void TC_0442_Chips_팟캐스트_재생_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "최근에 들은"));
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "이어서"));
	...
	public void TC_0444_Chips_팟빵_방송명으로팟캐스트_재생_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "TBS 김어준의 뉴스공장"));
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "들려드릴게요"));
	...
	public void TC_0445_Chips_팟빵_구독_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "구독 리스트에 추가했습니다."));
		Thread.sleep(3000);
	...
	public void TC_0446_Chips_팟빵_구독삭제_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "구독 팟캐스트 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "구독 리스트에서 삭제 했습니다."));
		Thread.sleep(3000);
	...
	public void TC_0447_Chips_팟빵_재생시간이동_확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("3분 다음으로 이동해줘", Chips_001, ServerName, AccessToken, "podcast");
	...
	public void TC_0455_Chips_팟빵_컨트롤러_에피소드_재생_확인(Method method) throws Exception {
		...
		util.SWFsendPost("팟빵에서 김어준의 뉴스공장 틀어줘", Chips_001, ServerName, AccessToken);
		Thread.sleep(2000);
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "김어준의 뉴스공장"));
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service,  "들려드릴게요."));
	...
	public void TC_0456_Chips_팟빵_컨트롤러_일시정지_확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("일시정지", Chips_001, ServerName, AccessToken, "podcast");
		util.SWFsendPost_playStatus("일시정지", Chips_001, ServerName, AccessToken, "podcast");
		Thread.sleep(5000);
	...
	public void TC_0457_Chips_팟빵_컨트롤러_일시정지취소_확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("일시정지 취소", Chips_001, ServerName, AccessToken, "podcast");
		Thread.sleep(3000);
	...
	public void TC_0462_Chips_팟빵_이전_확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("이전", Chips_001, ServerName, AccessToken, "music");
		Thread.sleep(3000);
	...
	public void TC_0463_Chips_팟빵_다음_확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("다음", Chips_001, ServerName, AccessToken, "music");
		Thread.sleep(3000);
		util.SWFsendPost_playStatus("다음", Chips_001, ServerName, AccessToken, "music");
		Thread.sleep(3000);
		util.SWFsendPost_playStatus("다음", Chips_001, ServerName, AccessToken, "music");
	...
	public void TC_0464_Chips_팟빵_이전팟캐스트_확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("팟빵에서 김어준 뉴스 공장 틀어줘", Chips_001, ServerName, AccessToken, "podcast");
		Thread.sleep(3000);
		...
		util.SWFsendPost_playStatus("이전 팟캐스트", Chips_001, ServerName, AccessToken, "podcast");
		Thread.sleep(4000);
	...
	public void TC_0465_Chips_팟빵_다음팟캐스트__확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("다음 팟캐스트", Chips_001, ServerName, AccessToken, "podcast");
		Thread.sleep(4000);
	...
	public void TC_0466_Chips_팟빵_재생시간앞으로이동_확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("2분 앞으로 이동", Chips_001, ServerName, AccessToken, "podcast");
		Thread.sleep(3000);
	...
	public void TC_0467_Chips_팟빵_재생시간뒤으로이동_확인(Method method) throws Exception {
		...
		util.SWFsendPost_playStatus("1분 뒤로 이동", Chips_001, ServerName, AccessToken, "podcast");
		Thread.sleep(3000);
