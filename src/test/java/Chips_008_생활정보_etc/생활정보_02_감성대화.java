...
public class 생활정보_02_감성대화 extends Chips_TestCase {
	...
	public void TC_0710_Chips_감성대화_안부인사_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.Domain_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "chitchat"));
		
		test.log(Status.INFO, "greet_001 intent 확인");
		Assert.assertTrue(util.intent_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "greet_001"));
	}
	...
	public void TC_0711_Chips_감성대화_이벤트절기상황1_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.intent_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "company.day_001"));
	}
	...
	public void TC_0712_Chips_감성대화_이벤트절기상황2_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.intent_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "event.date_002"));
	}
	...
	public void TC_0713_Chips_감성대화_피곤질병_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.intent_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "sickness.tired_001"));
	}
	...
	public void TC_0714_Chips_감성대화_감사_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.intent_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "thanks_001"));
	}
	...
	public void TC_0721_Chips_감성대화_고객센터번호_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.actionType_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "usd"));
