...
public class 생활정보_13_운세 extends Chips_TestCase {
	...
	public void accessToken얻기() throws Exception {
	    ...
	    String tid = util.TransactionID_JsonParsing(nuguqa002, Chips_002, ServerName, Service);
	...
	public void TC_0801_Chips_운세_생년월일미등록_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc_ContainsSet(nuguqa002, Chips_002, ServerName, Service, data.미등록운세_set));
	...
	public void TC_0802_Chips_운세_생년월일등록_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "운세 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "당신의 오늘의 운세를 알려드릴게요."));
	...
	public void TC_0803_Chips_운세_띠별운세_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "오늘의 양띠 운세를 알려드릴게요."));
	...
	public void TC_0804_Chips_운세_띠별운세_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "양띠 운세 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "내일의 쥐띠 운세를 알려드릴게요."));
	...
	public void TC_0805_Chips_운세_생년별운세_확인(Method method) throws Exception {
		...
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "79년 1월 4일생, 오늘의 운세를 알려드릴게요."));
	...
	public void TC_0806_Chips_운세_생년별운세_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "생년 운세 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "음력 81년 8월 21일생, 오늘의 운세를 알려드릴게요."));
	...
	public void TC_0807_Chips_운세_생년별운세_확인(Method method) throws Exception {
		...
		test.log(Status.INFO, "생년 운세 TTS 확인");
		Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "01년 1월 4일생, 오늘의 운세를 알려드릴게요."));
	...
	public void TC_0807_Chips_운세_이번주_미지원_확인(Method method) throws Exception {
		...
		if (미지원기간.equals("A구간")) {
			...
			Assert.assertTrue(util.TTS_Assertfunc(nuguqa001, Chips_001, ServerName, Service, "저는 오늘과 내일의 운세만 알려드릴 수 있어요."));
